...
int ssLep(int nLep, int lep1pdg, int lep2pdg, int lep3pdg, int lep4pdg = 0){
	int charge=1;
	if(abs(lep1pdg)!=15) charge*=lep1pdg;
	if(abs(lep2pdg)!=15) charge*=lep2pdg;
	if(abs(lep3pdg)!=15) charge*=lep3pdg;
	if(abs(lep4pdg)!=15) charge*=lep4pdg;
	return (charge>0);
}
...
int isFakeE(int nLep, int comp, int lep1mcUCSX, int lep2mcUCSX, int lep3mcUCSX = 0, int lep4mcUCSX = 0) {
	if(nLep!=comp/10000) { return 0; cout << "bla" << comp << "." << nLep << endl; return 0;}
	//cout << "el: "<< comp <<": "<< lep1mcUCSX <<","<<lep2mcUCSX <<","<<lep3mcUCSX <<","<<lep4mcUCSX <<","<<endl;
    comp -= nLep*10000;
    //cout << ">" << comp << ":" << comp/1000<< endl;
	bool isFake = false;
	if(lep1mcUCSX==2||lep1mcUCSX==3){ isFake=true; if(comp/1000==0) return 1; }
    if(isFake) return 0;
    comp -= (comp/1000)*1000;
	if(lep2mcUCSX==2||lep2mcUCSX==3){ isFake=true; if(comp/100 ==0) return 1; }
    if(isFake) return 0;
    comp -= (comp/100 )*100 ;
	if(lep3mcUCSX==2||lep3mcUCSX==3){ isFake=true; if(comp/10  ==0) return 1; }
    if(isFake) return 0;
    comp -= (comp/10  )*10  ;
	if(lep4mcUCSX==2||lep4mcUCSX==3){ isFake=true; if(comp/1   ==0) return 1; }
    return 0;
}

int isFakeApplE(int nLep, int comp, int lep1tight, int lep2tight, int lep3tight = 1, int lep4tight = 1) {
	if(nLep!=comp/10000) return 0;
    comp -= nLep*10000;
	bool isFake = false;
	if(!lep1tight){ isFake=true; if(comp/1000==0) return 1; }
    if(isFake) return 0;
    comp -= (comp/1000)*1000;
	if(!lep2tight){ isFake=true; if(comp/100 ==0) return 1; }
    if(isFake) return 0;
    comp -= (comp/100 )*100 ;
	if(!lep3tight){ isFake=true; if(comp/10  ==0) return 1; }
    if(isFake) return 0;
    comp -= (comp/10  )*10  ;
	if(!lep4tight){ isFake=true; if(comp/1   ==0) return 1; }
    return 0;
}

int isFakeEsecond(int nLep, int comp, int lep1mcUCSX, int lep2mcUCSX, int lep3mcUCSX = 0, int lep4mcUCSX = 0) {
	if(nLep!=comp/10000) { return 0; }
    comp -= nLep*10000;
	bool isFake = false;
	if(lep1mcUCSX==2||lep1mcUCSX==3) isFake = true;
    comp -= (comp/1000)*1000;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/100==0){return 1;} isFake=true;  }
    comp -= (comp/100 )*100 ;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/10 ==0){return 1;} isFake=true;  }
    comp -= (comp/10  )*10  ;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/1  ==0){return 1;} isFake=true;  }
    return 0;
}

int isFakeM(int nLep, int comp, int lep1mcUCSX, int lep2mcUCSX, int lep3mcUCSX = 0, int lep4mcUCSX = 0) {
	if(nLep!=comp/10000) return 0;
    comp -= nLep*10000;
	bool isFake = false;
	if(lep1mcUCSX==2||lep1mcUCSX==3){ isFake=true; if(comp/1000==1) return 1; }
    if(isFake) return 0;
    comp -= (comp/1000)*1000;
	if(lep2mcUCSX==2||lep2mcUCSX==3){ isFake=true; if(comp/100 ==1) return 1; }
    if(isFake) return 0;
    comp -= (comp/100 )*100 ;
	if(lep3mcUCSX==2||lep3mcUCSX==3){ isFake=true; if(comp/10  ==1) return 1; }
    if(isFake) return 0;
    comp -= (comp/10  )*10  ;
	if(lep4mcUCSX==2||lep4mcUCSX==3){ isFake=true; if(comp/1   ==1) return 1; }
    return 0;
}

int isFakeApplM(int nLep, int comp, int lep1tight, int lep2tight, int lep3tight = 1, int lep4tight = 1) {
	if(nLep!=comp/10000) return 0;
    comp -= nLep*10000;
	bool isFake = false;
	if(!lep1tight){ isFake=true; if(comp/1000==1) return 1; }
    if(isFake) return 0;
    comp -= (comp/1000)*1000;
	if(!lep2tight){ isFake=true; if(comp/100 ==1) return 1; }
    if(isFake) return 0;
    comp -= (comp/100 )*100 ;
	if(!lep3tight){ isFake=true; if(comp/10  ==1) return 1; }
    if(isFake) return 0;
    comp -= (comp/10  )*10  ;
	if(!lep4tight){ isFake=true; if(comp/1   ==1) return 1; }
    return 0;
}

int isFakeMsecond(int nLep, int comp, int lep1mcUCSX, int lep2mcUCSX, int lep3mcUCSX = 0, int lep4mcUCSX = 0) {
	if(nLep!=comp/10000) { return 0; }
    comp -= nLep*10000;
	bool isFake = false;
	if(lep1mcUCSX==2||lep1mcUCSX==3) isFake = true;
    comp -= (comp/1000)*1000;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/100==1){return 1;} isFake=true;  }
    comp -= (comp/100 )*100 ;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/10 ==1){return 1;} isFake=true;  }
    comp -= (comp/10  )*10  ;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/1  ==1){return 1;} isFake=true;  }
    return 0;
}

int isFakeT(int nLep, int comp, int lep1mcUCSX, int lep2mcUCSX, int lep3mcUCSX = 0, int lep4mcUCSX = 0) {
	if(nLep!=comp/10000) return 0;
    comp -= nLep*10000;
	bool isFake = false;
	if(lep1mcUCSX==2||lep1mcUCSX==3){ isFake=true; if(comp/1000==2) return 1; }
    if(isFake) return 0;
    comp -= (comp/1000)*1000;
	if(lep2mcUCSX==2||lep2mcUCSX==3){ isFake=true; if(comp/100 ==2) return 1; }
    if(isFake) return 0;
    comp -= (comp/100 )*100 ;
	if(lep3mcUCSX==2||lep3mcUCSX==3){ isFake=true; if(comp/10  ==2) return 1; }
    if(isFake) return 0;
    comp -= (comp/10  )*10  ;
	if(lep4mcUCSX==2||lep4mcUCSX==3){ isFake=true; if(comp/1   ==2) return 1; }
    return 0;
}

int isFakeApplT(int nLep, int comp, int lep1tight, int lep2tight, int lep3tight = 1, int lep4tight = 1) {
	if(nLep!=comp/10000) return 0;
    comp -= nLep*10000;
	bool isFake = false;
	if(!lep1tight){ isFake=true; if(comp/1000==2) return 1; }
    if(isFake) return 0;
    comp -= (comp/1000)*1000;
	if(!lep2tight){ isFake=true; if(comp/100 ==2) return 1; }
    if(isFake) return 0;
    comp -= (comp/100 )*100 ;
	if(!lep3tight){ isFake=true; if(comp/10  ==2) return 1; }
    if(isFake) return 0;
    comp -= (comp/10  )*10  ;
	if(!lep4tight){ isFake=true; if(comp/1   ==2) return 1; }
    return 0;
}

int isFakeTsecond(int nLep, int comp, int lep1mcUCSX, int lep2mcUCSX, int lep3mcUCSX = 0, int lep4mcUCSX = 0) {
	if(nLep!=comp/10000) { return 0; }
    comp -= nLep*10000;
	bool isFake = false;
	if(lep1mcUCSX==2||lep1mcUCSX==3) isFake = true;
    comp -= (comp/1000)*1000;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/100==2){return 1;} isFake=true;  }
    comp -= (comp/100 )*100 ;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/10 ==2){return 1;} isFake=true;  }
    comp -= (comp/10  )*10  ;
	if(lep2mcUCSX==2||lep2mcUCSX==3) {if(isFake && comp/1  ==2){return 1;} isFake=true;  }
    return 0;
}

int flavorComp(int lep1pdg, int lep2pdg, int lep3pdg, int lep4pdg = 0){
	int comp = 20000;
	if(abs(lep3pdg)>0) comp=30000;
	if(abs(lep4pdg)>0) comp=40000;
	comp += (abs(lep1pdg)-11)/2*1000;
	comp += (abs(lep2pdg)-11)/2*100 ;
	comp += (max(0, abs(lep3pdg)-11))/2*10  ;
	comp += (max(0, abs(lep4pdg)-11))/2*1   ;
	//cout << lep1pdg<<";"<<lep2pdg<<";"<<lep3pdg<<";"<<lep4pdg<<";"<<comp<<endl;
	return comp;
}
