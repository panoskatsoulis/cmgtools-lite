...
O="/afs/cern.ch/user/c/cheidegg/www/heppy/2018-01-01_ewk80X_someDYTest" # Do NOT give a trailing /
O="/afs/cern.ch/user/c/cheidegg/www/heppy/2018-01-02_ewk80X_expectedThesis" # Do NOT give a trailing /
O="/afs/cern.ch/user/c/cheidegg/www/heppy/2018-01-03_ewk80X_wzThesis" # Do NOT give a trailing /
L=35.9
FL=35.9
QUEUE="--noRatio" #"-q all.q"
BLIND="-X blinding" #""
...
python susy-interface/plotmaker.py 3l "3lA" $T $O -l $L  --make datasig --selPlots "mll3l" -o SR --flags "--perBin $BLIND" $QUEUE -p "data;fakes_appldata;prompt_.*;rares_.*;convs;sig_TChiWZ_200_100" 
#python susy-interface/plotmaker.py 3l "3lC" $T $O -l $L  --make data --plots perCateg -p "fakes_matched" -o SR   --flags "--perBin $BLIND" $QUEUE
#python susy-interface/plotmaker.py 3l "3lC" $T $O -l $L  --make mix --selPlots "mtW3l;mT2T3l;mT2L3l" -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;sig_TChiSlepSnu_TE_400_350;sig_TChiSlepSnu_TE_1100_1"
#python susy-interface/plotmaker.py 3l "3lD;3lF" $T $O -l $L  --make mix --selPlots "mtW3l;mT2T3l;mT2L3l" -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;sig_TChiSlepSnu_TD_600_1" 
