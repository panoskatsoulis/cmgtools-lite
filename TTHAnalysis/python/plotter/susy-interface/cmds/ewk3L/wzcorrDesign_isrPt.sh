...
if [ $DO = "plots_ht0to100" ]; then
    O="/afs/cern.ch/user/c/cheidegg/www/heppy/2017-11-06_ewk80X_frexp" # Do NOT give a trailing /
    #O="/afs/cern.ch/user/c/cheidegg/www/heppy/2017-04-08_ewk80X_wzcorr" # Do NOT give a trailing /

    ## bkg versus sig
    python susy-interface/plotmaker.py 3l 3lA $T $O -l $L  --make mix --plots evt    -o bkgsig_ht0to100 --flags "--perBin $BLIND -A met isrjet 'htJet30j_Mini<100'" -p "fakes_matched;prompt_.*;rares_.*;convs;sig_TChiWZ_200_100;sig_TChiWZ_350_250" $QUEUE --lspam "Simulation" 
...
if [ $DO = "plots_ht200toInf" ]; then
    O="/afs/cern.ch/user/c/cheidegg/www/heppy/2017-11-06_ewk80X_frexp" # Do NOT give a trailing /
    #O="/afs/cern.ch/user/c/cheidegg/www/heppy/2017-08-09_ewk80X_cwrexp" # Do NOT give a trailing /
