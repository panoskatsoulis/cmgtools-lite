...
#### default data-driven fakes
##python susy-interface/plotmaker.py sos2l dyLow $T $O -l $RL --make datasig --plots perCateg -o SR_crus --flags "--perBin $BLIND" $QUEUE --mccs "susy-sos-v1/mcc_triggerdefs.txt;susy-sos-v1/crdy/mcc_dy_2016.txt;susy-sos-v1/mcc_sos.txt;susy-sos-v1/2l/mcc_sf_met.txt;susy-sos-v1/2l/mcc2016/mcc_sf_fakes_dyLow.txt"
##python susy-interface/plotmaker.py sos2l dyMed $T $O -l $FL --make datasig --plots perCateg -o SR_crus --flags "--perBin $BLIND" $QUEUE --mccs "susy-sos-v1/mcc_triggerdefs.txt;susy-sos-v1/crdy/mcc_dy_2016.txt;susy-sos-v1/mcc_sos.txt;susy-sos-v1/2l/mcc_sf_met.txt;susy-sos-v1/2l/mcc2016/mcc_sf_fakes_dyLow.txt"
##
#### fakes from MC
python susy-interface/plotmaker.py sos2l dyLow $T $O -l $RL --make datasig --plots all -o SRmc_crus --flags "--perBin $BLIND" -p "data;prompt_.*;rares;fakes_matched_.*" $QUEUE --mccs "susy-sos-v1/mcc_triggerdefs.txt;susy-sos-v1/crdy/mcc_dy_2017.txt;susy-sos-v1/mcc_sos.txt;susy-sos-v1/2l/mcc_sf_met.txt;susy-sos-v1/2l/mcc2017/mcc_sf_fakes_dyLow.txt" --cuts susy-sos-v1/crdy/cuts_dy_2017.txt --mca susy-sos-v1/2l/mca_sos_2017.txt -W 'wBG17' --smcfriends 0_pileup_v1
python susy-interface/plotmaker.py sos2l dyMed $T $O -l $FL --make datasig --plots all -o SRmc_crus --flags "--perBin $BLIND" -p "data;prompt_.*;rares;fakes_matched_.*" $QUEUE --mccs "susy-sos-v1/mcc_triggerdefs.txt;susy-sos-v1/crdy/mcc_dy_2017.txt;susy-sos-v1/mcc_sos.txt;susy-sos-v1/2l/mcc_sf_met.txt;susy-sos-v1/2l/mcc2017/mcc_sf_fakes_dyLow.txt" --cuts susy-sos-v1/crdy/cuts_dy_2017.txt --mca susy-sos-v1/2l/mca_sos_2017.txt -W 'wBG17' --smcfriends 0_pileup_v1
##
#### semi-data-driven fakes
###python susy-interface/plotmaker.py sos2l dyLow $T $O -l $RL --make datasig --plots perCateg -o SRsemi_crus --flags "--perBin $BLIND --plotgroup fakes_applmc1+=fakes_applmc2" -p "data;prompt_.*;rares;fakes_applmc1;fakes_applmc2" $QUEUE --mccs "susy-sos-v1/mcc_triggerdefs.txt;susy-sos-v1/crdy/mcc_dy_2016.txt;susy-sos-v1/mcc_sos.txt;susy-sos-v1/2l/mcc_sf_met.txt;susy-sos-v1/2l/mcc2016/mcc_sf_fakes_dyLow.txt"
###python susy-interface/plotmaker.py sos2l dyMed $T $O -l $FL --make datasig --plots perCateg -o SRsemi_crus --flags "--perBin $BLIND --plotgroup fakes_applmc1+=fakes_applmc2" -p "data;prompt_.*;rares;fakes_applmc1;fakes_applmc2" $QUEUE --mccs "susy-sos-v1/mcc_triggerdefs.txt;susy-sos-v1/crdy/mcc_dy_2016.txt;susy-sos-v1/mcc_sos.txt;susy-sos-v1/2l/mcc_sf_met.txt;susy-sos-v1/2l/mcc2016/mcc_sf_fakes_dyLow.txt"
##
##
##
#### Sideband
