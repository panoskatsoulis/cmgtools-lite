...
if __name__ == "__main__":
    ...
    os.system("cp -r /afs/cern.ch/user/c/cheidegg/ec/CMSSW_8_0_25/src/CMGTools/TTHAnalysis/python/plotter/susy-sos-v1 "+os.path.dirname(outname)+"/susy-sos-v1") # hard coded, but i don't care!
