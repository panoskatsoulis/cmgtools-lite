...
combine -M ProfileLikelihood comb.root -n ${MOD} -m ${M1} -s ${M2} --uncapped 1 --significance --rMin -5 &&\
echo combine -M ProfileLikelihood comb.root -n ${MOD} -m ${M1} -s ${M2} --uncapped 1 --significance --rMin -5 )
