...
class sms():
    ...
    def T2tt(self):
        ...
        self.label= "pp #rightarrow #tilde{t} #tilde{t}, #tilde{t} #rightarrow #tilde{#chi}^{+}_{1} b, #tilde{#chi}^{+}_{1} #rightarrow #tilde{#chi}^{0}_{1} W^{+}"
        self.label2= ""
        # scan range to plot
        self.Xmin = 300.
        self.Xmax = 520.
    ...
    def TChiNeuWZ(self):
        ...
        self.Xmin = 100.
        self.Xmax = 260.
        self.Ymin = 0 # ORIGINAL                                                                                                                                                                             
        self.Ymax = 260  # ORIGINAL 
        #self.Ymin =   7.5 # ORIGINAL
        #self.Ymax =  50. # ORIGINAL
        self.Zmin = 0.1#0.1
        self.Zmax = 100#10.   
        # produce sparticle
        ...
        #self.LSP = "#Delta m ( #tilde{#chi}^{0}_{2},#tilde{#chi}^{0}_{1} ) [GeV]" ORIGINAL
        # turn off diagonal lines
        self.diagOn = False
        self.diagX = array('d',[100,250])
        self.diagY = array('d',[ 93,243])
