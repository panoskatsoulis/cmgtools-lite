...
if analysis=='SOS':
    ...
    l1Analyzer = cfg.Analyzer(L1Analyzer, name='l1Analyzer', sample="SMS_TChiWZ")
    ...
    #treeProducer.globalVariables.append(NTupleVariable("l1egs", lambda ev: ev.L1egs if ev.L1egs is not None else None, int, help="number of L1 egs"))
    ...
    treeProducer.globalVariables.append(NTupleVariable("l1MET", lambda ev: ev.L1met, float, help="L1 MET"))
    treeProducer.globalVariables.append(NTupleVariable("l1MET_phi", lambda ev: ev.L1met_phi, float, help="L1 MET phi"))
