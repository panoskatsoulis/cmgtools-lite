...
process = WJetsToLNuHT
selectedComponents = []
if type(process) is list:
    selectedComponents += process#+samples_mainBkg#+samples_fakesBkg#+samples_rareBkg + samples_mainBkg + samples_mainBkgVV
else:
    selectedComponents.append(process)
